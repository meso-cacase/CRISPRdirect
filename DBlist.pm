...
OryAfe1.0      	172.18.8.75	48098	Aardvark (Orycteropus afer) genome, OryAfe1.0 (May, 2012)
PoeFor_5.1.2   	172.18.8.75	48099	Amazon molly (Poecilia formosa) genome, Poecilia_formosa-5.1.2 (Oct, 2013)
CSAV2.0        	172.18.8.75	48100	Sea squirt (Ciona savignyi) genome, CSAV 2.0 (Oct, 2005)
AstMex102      	172.18.8.75	48101	Cave fish (Astyanax mexicanus) genome, AstMex102 (Apr, 2013)
PelSin_1.0     	172.18.8.75	48102	Chinese softshell turtle (Pelodiscus sinensis) genome, PelSin_1.0 (Oct, 2011)
MacFas5.0      	172.18.8.75	48103	Crab-eating macaque (Macaca fascicularis) genome, MacFas5.0 (Jun, 2013)
BGI_duck_1.0   	172.18.8.75	48104	Duck (Anas platyrhynchos) genome, BGI_duck_1.0 (Apr, 2013)
FicAlb_1.4     	172.18.8.75	48105	Flycatcher (Ficedula albicollis) genome, FicAlb_1.4 (Jan, 2012)
Pham           	172.18.8.75	48106	Hamadryas baboon (Papio hamadryas) genome, Pham (Nov, 2008)
Xipmac4.4.2    	172.18.8.75	48107	Platyfish (Xiphophorus maculatus) genome, Xipmac4.4.2 (Jan, 2012)
MicOch1.0      	172.18.8.75	48108	Prairie vole (Microtus ochrogaster) genome, MicOch1.0 (Nov, 2012)
PhyMac_2.0.2   	172.18.8.75	48109	Sperm whale (Physeter macrocephalus) genome, PhyMac_2.0.2 (Sep, 2013)
LepOcu1        	172.18.8.75	48110	Spotted gar (Lepisosteus oculatus) genome, LepOcu1 (Dec, 2011)
ChlSab1.1      	172.18.8.75	48111	Green monkey (Chlorocebus sabaeus) genome, ChlSab1.1 (Mar, 2014)
Acyr_2.0       	172.18.8.75	48112	Pea aphid (Acyrthosiphon pisum) genome, Acyr_2.0 (Jun, 2010)
AaegL3         	172.18.8.75	48113	Yellowfever mosquito (Aedes aegypti) genome, AaegL3 (Dec, 2013)
Aqu1           	172.18.8.75	48114	Sponge (Amphimedon queenslandica) genome, Aqu1 (Oct, 2010)
AdarC3         	172.18.8.75	48115	Mosquito (Anopheles darlingi) genome, AdarC3 (Jan, 2014)
Attacep1.0     	172.18.8.75	48116	Leafcutter ant (Atta cephalotes) genome, Attacep1.0 (Jul, 2012)
ASM15162v1     	172.18.8.75	48117	Silkworm (Bombyx mori) genome, ASM15162v1 (Feb, 2013)
B_malayi_3.0   	172.18.8.75	48118	Filarial nematode worm (Brugia malayi) genome, B_malayi-3.0 (Dec, 2012)
Capte_v1.0     	172.18.8.75	48119	Polychaete worm (Capitella teleta) genome, Capitella teleta v1.0 (Dec, 2012)
oyster_v9      	172.18.8.75	48120	Pacific oyster (Crassostrea gigas) genome, oyster_v9 (Sep, 2012)
CpipJ2         	172.18.8.75	48121	Southern house mosquito (Culex quinquefasciatus) genome, CpipJ2 (Jan, 2007)
DanPle_1.0     	172.18.8.75	48122	Monarch butterfly (Danaus plexippus) genome, DanPle_1.0 (Nov, 2011)
Dappu_V1.0     	172.18.8.75	48123	Water flea (Daphnia pulex) genome, V1.0 (Feb, 2011)
DendPond_1.0   	172.18.8.75	48124	Mountain pine beetle (Dendroctonus ponderosae) genome, DendPond_male_1.0 (Apr, 2013)
dwil_caf1      	172.18.8.75	48125	Fruit fly (Drosophila willistoni) genome, dwil_caf1 (Jul, 2008)
Hmel1          	172.18.8.75	48126	Postman butterfly (Heliconius melpomene) genome, Hmel1 (Feb, 2012)
Helro1         	172.18.8.75	48127	Californian leech (Helobdella robusta) genome, Helro1 (Dec, 2012)
IscaW1         	172.18.8.75	48128	Black-legged tick (Ixodes scapularis) genome, IscaW1 (Aug, 2007)
Loa_loa_V3     	172.18.8.75	48129	Eye worm (Loa loa) genome, Loa_loa_V3 (Jan, 2010)
Lotgi1         	172.18.8.75	48130	Giant owl limpet (Lottia gigantea) genome, Lotgi1 (Jan, 2013)
Msca1          	172.18.8.75	48131	Humpbacked fly (Megaselia scalaris) genome, Msca1 (Feb, 2013)
MelCinx1.0     	172.18.8.75	48132	Glanville fritillary (Melitaea cinxia) genome, MelCinx1.0 (Jul, 2014)
MneLei         	172.18.8.75	48133	Sea walnut (Mnemiopsis leidyi) genome, MneLei_Aug2011 (Sep, 2011)
Nvit_2.1       	172.18.8.75	48134	Parasitic wasp (Nasonia vitripennis) genome, Nvit_2.1 (Nov, 2012)
ASM20922v1     	172.18.8.75	48135	Starlet sea anemone (Nematostella vectensis) genome, ASM20922v1 (Sep, 2007)
Cameroon_v3    	172.18.8.75	48136	Parasitic nematode (Onchocerca volvulus) genome, Cameroon_v3 (Nov, 2013)
PhumU2         	172.18.8.75	48137	Body louse (Pediculus humanus) genome, PhumU2 (Nov, 2008)
RproC1         	172.18.8.75	48138	Triatomid bug (Rhodnius prolixus) genome, RproC1 (Dec, 2010)
ASM23792v2     	172.18.8.75	48139	Blood fluke (Schistosoma mansoni) genome, ASM23792v2 (Apr, 2012)
Si_gnG         	172.18.8.75	48140	Red imported fire ant (Solenopsis invicta) genome, Si_gnG (Feb, 2011)
Smar1          	172.18.8.75	48141	European centipede (Strigamia maritima) genome, Smar1 (Feb, 2013)
ASM23943v1     	172.18.8.75	48142	Two-spotted spider mite (Tetranychus urticae) genome, ASM23943v1 (Nov, 2011)
Tcas3          	172.18.8.75	48143	Red flour beetle (Tribolium castaneum) genome, Tcas3 (Feb, 2010)
Tspiralis1     	172.18.8.75	48144	Trichina worm (Trichinella spiralis) genome, Tspiralis1 (Mar, 2011)
ASM15027v1     	172.18.8.75	48145	Trichoplax adhaerens genome, ASM15027v1 (Aug, 2006)
ZooNev1.0      	172.18.8.75	48146	Dampwood termite (Zootermopsis nevadensis) genome, ZooNev1.0 (Jun, 2014)
ASM34733v1     	172.18.8.75	48147	Tausch's goatgrass (Aegilops tauschii) genome, ASM34733v1 (Dec, 2013)
AMTR1.0        	172.18.8.75	48148	Amborella trichopoda genome, AMTR1.0 (Jan, 2014)
Araly_v.1.0    	172.18.8.75	48149	Lyre-leaved rock-cress (Arabidopsis lyrata) genome, v.1.0 (Dec, 2008)
TAIR10_en      	172.18.8.75	48150	Thale cress (Arabidopsis thaliana) genome, TAIR10 (Sep, 2010)
Bradi_v1.0     	172.18.8.75	48151	Purple false brome (Brachypodium distachyon) genome, v1.0 (Jan, 2009)
Braol_v2.1     	172.18.8.75	48152	Wild cabbage (Brassica oleracea) genome, v2.1
IVFCAASv1      	172.18.8.75	48153	Chinese cabbage (Brassica rapa ssp. pekinensis) genome, IVFCAASv1 (Aug, 2009)
Chlre_v3.1     	172.18.8.75	48154	Green algae (Chlamydomonas reinhardtii) genome, v3.1 (Nov, 2007)
ASM9120v1      	172.18.8.75	48155	Red alga (Cyanidioschyzon merolae) genome, ASM9120v1 (Nov, 2008)
Soybn_V1.0     	172.18.8.75	48156	Soybean (Glycine max) genome, V1.0 (Jan, 2010)
Horvu_v1       	172.18.8.75	48157	Barley (Hordeum vulgare) genome, 082214v1 (Mar, 2012)
Lperr_V1.4     	172.18.8.75	48158	Leersia perrieri genome, Lperr_V1.4 (Mar, 2014)
MedtrA17_4.0   	172.18.8.75	48159	Barrel medic (Medicago truncatula) str. A17 genome, MedtrA17_4.0 (Jun, 2014)
MA1            	172.18.8.75	48160	Banana (Musa acuminata) genome, MA1 (Aug, 2012)
Obart_v1.0     	172.18.8.75	48161	African wild rice (Oryza barthii) genome, Obart_v1.0 (Apr, 2014)
Orybr_v1.4b    	172.18.8.75	48162	African wild rice (Oryza brachyantha) genome, Oryza_brachyantha.v1.4b (May, 2011)
AGI1.1         	172.18.8.75	48163	African wild rice (Oryza glaberrima) genome, AGI1.1 (May, 2011)
Orygl          	172.18.8.75	48164	Brazilian wild rice (Oryza glumaepatula) genome, ALNU02000000 (Aug, 2013)
Orylo_v0117    	172.18.8.75	48165	Longstamen rice (Oryza longistaminata) genome, v0117-2013Aug (Aug, 2013)
Oryme_v1.3     	172.18.8.75	48166	Australian wild rice (Oryza meridionalis) genome, Oryza_meridionalis_v1.3 (Oct, 2014)
Oryni          	172.18.8.75	48167	Indian wild rice (Oryza nivara) genome, AWHD00000000 (Aug, 2013)
Orypu          	172.18.8.75	48168	Red rice (Oryza punctata) genome, AVCL00000000 (Aug, 2013)
PRJEB4137      	172.18.8.75	48169	Brownbeard rice (Oryza rufipogon) genome, PRJEB4137 (Aug, 2013)
ASM465v1       	172.18.8.75	48170	Rice (Oryza sativa ssp. indica) genome, ASM465v1 (Jan, 2005)
ASM9206v1      	172.18.8.75	48171	Ostreococcus lucimarinus genome, ASM9206v1 (Jan, 2011)
ASM242v1       	172.18.8.75	48172	Moss (Physcomitrella patens) genome, ASM242v1 (Jul, 2006)
Poptr_JGI2.0   	172.18.8.75	48173	Western balsam poplar (Populus trichocarpa) genome, JGI2.0 (Jan, 2010)
Prupe1_0       	172.18.8.75	48174	Peach (Prunus persica) genome, Prupe1_0 (Mar, 2013)
Selml_v1.0     	172.18.8.75	48175	Spikemoss (Selaginella moellendorffii) genome, v1.0 (May, 2011)
Setit_JGIv2.0  	172.18.8.75	48176	Foxtail millet (Setaria italica) genome, JGIv2.0 (Jan, 2012)
SL2.50         	172.18.8.75	48177	Tomato (Solanum lycopersicum) str. Heinz 1706 genome, SL2.50 (Oct, 2014)
SolTub_3.0     	172.18.8.75	48178	Potato (Solanum tuberosum) genome, SolTub_3.0 (May, 2011)
Sorbi1         	172.18.8.75	48179	Sorghum (Sorghum bicolor) genome, Sorbi1 (Dec, 2007)
Thecc_20110822 	172.18.8.75	48180	Cacao (Theobroma cacao) genome, Theobroma_cacao_20110822 (May, 2014)
IWGSC1.0       	172.18.8.75	48181	Wheat (Triticum aestivum) genome, IWGSC1.0+popseq (Nov, 2014)
ASM34745v1     	172.18.8.75	48182	Red wild einkorn (Triticum urartu) genome, ASM34745v1 (Apr, 2013)
IGGP_12x       	172.18.8.75	48183	Grape (Vitis vinifera) genome, IGGP_12x (Jun, 2011)
AGPv3          	172.18.8.75	48184	Corn (Zea mays) genome, AGPv3 (Apr, 2013)
Ppatens_251_v3           	172.18.8.75	48185	Moss (Physcomitrella patens) genome, v3.0 (Oct, 2007)
Smoellendorffii_91_v1    	172.18.8.75	48186	Spikemoss (Selaginella moellendorffii) genome, v1.0 (Dec, 2007)
Creinhardtii_281_v5_5    	172.18.8.75	48187	Green algae (Chlamydomonas reinhardtii) genome, v5.5 (May, 2014)
Olucimarinus_231_v2      	172.18.8.75	48188	Ostreococcus lucimarinus genome, v2.0 (Jan, 2011)
Cgrandiflora_v1          	172.18.8.75	48189	Capsella grandiflora genome, v1.1
Crubella_v1              	172.18.8.75	48190	Red shepherd's purse (Capsella rubella) genome, v1.0
Cpapaya_r.Dec2008        	172.18.8.75	48191	Papaya (Carica papaya) genome, ASGPBv0.4
CsubellipsoideaC169_v2.0 	172.18.8.75	48192	Coccomyxa subellipsoidea C-169 genome, v2.0
Csativus_v1              	172.18.8.75	48193	Cucumber (Cucumis sativus) genome, v1.0
Egrandis_v2.0            	172.18.8.75	48194	Eucalyptus grandis genome, v2.0
Fvesca_v1.1              	172.18.8.75	48195	Strawberry (Fragaria vesca) genome, v1.1
Graimondii_v2.0          	172.18.8.75	48196	Cotton (Gossypium raimondii) genome, v2.1
Lusitatissimum_BGIv1.0   	172.18.8.75	48197	Flax (Linum usitatissimum) genome, v1.0
Mdomestica_v1.0          	172.18.8.75	48198	Apple (Malus domestica) genome, v1.0
Mesculenta_v6            	172.18.8.75	48199	Cassava (Manihot esculenta) genome, v6.1
MpusillaCCMP1545_v3.0    	172.18.8.75	48200	Picoplanktonic green alga (Micromonas pusilla) CCMP1545 genome, v3.0
MpusillaRCC299_v3.0      	172.18.8.75	48201	Picoplanktonic green alga (Micromonas pusilla) sp. RCC299 genome, v3.0
Mguttatus_v2.0           	172.18.8.75	48202	Monkey flower (Mimulus guttatus) genome, v2.0
Ppersica_v2.0            	172.18.8.75	48203	Peach (Prunus persica) genome, v2.1
Rcommunis_TIGR.0.1       	172.18.8.75	48204	Castor bean (Ricinus communis) genome, v0.1
Spolyrhiza_v1            	172.18.8.75	48205	Giant duckweed (Spirodela polyrhiza) genome, v2
Vcarteri_v2              	172.18.8.75	48206	Green alga (Volvox carteri) genome, v2.0
